...
const Profile = () => {
    ...
    useEffect(() => {
        document.title = 'Sean Outlet | My Profile';
                            ...
                            <div className="col-12">
                                ...
                                <div className="row justify-content-center">
                                    ...
                                    <div className="col-12 text-center">
                                        <CustomButton type="button" variant="primaryButton" className="me-3 mb-2" text="Edit Profile" onClick={() => { navigate('/edit-profile') }} />
                                        <CustomButton type="button" variant="secondaryButton" className="me-3 mb-2" text="Change Password" onClick={() => { navigate('/change-password') }} />
                                    </div>
